...
async def add_rmq_task(worker_key: str, queue_name: str, data: dict, **meta):
...
async def add_rmq_task_with_ret(worker_key: str, queue_name, data: dict, **meta):
    ...
    if "ret" in meta.keys():
        ...
        _ret = str(uuid.uuid4())
        meta["ret"] = _ret
    await add_rmq_task(worker_key, queue_name, data, **meta)
